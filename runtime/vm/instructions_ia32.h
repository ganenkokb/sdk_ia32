...
class PcRelativeCallPattern : public InstructionPattern<PcRelativeCallPattern> {
 public:
  static constexpr intptr_t kLowerCallingRange = static_cast<intptr_t>(-(DART_UINT64_C(1) << 31));
  static constexpr intptr_t kUpperCallingRange = static_cast<intptr_t>((DART_UINT64_C(1) << 31) - 1);
...
class PcRelativeTailCallPattern : public PcRelativeTrampolineJumpPattern {
 public:
  static constexpr intptr_t kLowerCallingRange = static_cast<intptr_t>(-(DART_INT64_C(1) << 31) + kLengthInBytes);
  static constexpr intptr_t kUpperCallingRange = static_cast<intptr_t>((DART_INT64_C(1) << 31) - 1);
